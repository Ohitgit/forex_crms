...
urlpatterns = [
    ...
    #notification
    path('client',User_Register,name="User_Register"),
    path('client-withdraw',Client_Withdraw,name="client_withdraw"),
    path('client-deposit',Client_Deposit,name="client_deposit"),
]
